    ...
    for i in range(0, len(monkeys)):
        for item in monkeys[i]["items"]:
            ...
            if worry_level % monkeys[i]["test_operand"] == 0:
                monkeys[monkeys[i]["result_operations"]["true"]]["items"].append(worry_level)
            else:
                monkeys[monkeys[i]["result_operations"]["false"]]["items"].append(worry_level)
